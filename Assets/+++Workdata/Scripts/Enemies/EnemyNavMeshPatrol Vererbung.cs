...
public class EnemyNavMeshPatrolVererbung : MonoBehaviour
{
    ...
    public virtual void EnterAggroDistance()
    {
    ...
    public virtual void ExitAggroDistance()
    {
        enemyState = EnemyState.Chasing;
    ...
    public virtual void EnterAttackDistance()
    {
        _canAttack = true;
        _agent.isStopped = true;
    }

    public virtual void ExitAttackDistance()
    {
        _canAttack = false;
        enemyState = EnemyState.Chasing;
        _agent.isStopped = false;
